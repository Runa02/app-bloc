...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('user-management', [HomeController::class, 'adminEditor'])->name('user-management');

	Route::get('article-management', [HomeController::class, 'create'])->name('article-management');
